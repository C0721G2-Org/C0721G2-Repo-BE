...
public interface IEmployeeRepository extends JpaRepository<Employee, String> {
    ...
    @Query(value = "insert into employees (id, address, date_of_birth,deleted, email, " +
            " gender,id_card, `name`, phone_number, app_user_id\n" +
            " ,degree_id, image_id,position_id) \n" +
            " VALUES (:id, :address, :date_of_birth,:deleted, :email, :gender,:id_card, :`name`, :phone_number, :app_user_id\n" +
            ",:degree_id, :image_id,:position_id)", nativeQuery = true)
    Employee saveEmployee(@Param("id") String id, @Param("address") String address,
                          @Param("date_of_birth") String date_of_birth, @Param("deleted")
                                  String deleted, @Param("email") String email,
